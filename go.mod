module github.com/gonobo/jsonapi/v2/extra/dynamodb

go 1.22.3

require github.com/aws/aws-sdk-go-v2/service/dynamodb v1.31.0

require github.com/gonobo/jsonapi/v2 v2.0.0-20240818221955-56bef91270fe
...
require (
	...
	github.com/gonobo/validator v0.0.6 // indirect
